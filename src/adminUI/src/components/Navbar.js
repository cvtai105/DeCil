    ...
    <div className="flex items-center justify-between p-4 bg-white shadow-sm">
      <div className="flex items-center space-x-4">
        <div className="flex space-x-4 ml-4">
          ...
          <Link to='/' className=" hover:underline">Decil</Link>
          <Link to="/orders" className="text-gray-600 hover:underline">Order</Link>
          <Link to="/blog" className="text-gray-600 hover:underline">Blog</Link>
        </div>
      </div>
